...
from .auth_serializers import LoginSerializer, LoginInputSerializer,LoginResponseSerializer

from xhtml2pdf import pisa

from .models import Student, Course, Enrollment
from .serializers import StudentSerializer, CourseSerializer, EnrollmentSerializer, PublicRegisterSerializer
...
class StudentViewSet(viewsets.ModelViewSet):
    ...
    def report_all_students(self, request):
        ...
        return _pdf_render(request, "enrollments/report_students_all.html", ctx, "all_students.pdf")
...
@extend_schema(
    tags=['auth'],
    request=LoginInputSerializer,               # <- body con username/password
    responses={
        200: LoginResponseSerializer,          # <- access, refresh, user{...}
